...
NODE_DESCRIPTIONS = [{u'label': u'Family',
           ...
           {u'label': u'FamilyGroup',
            u'name': u'Morphology',
            u'text': u'General geometry of a stratum (shape, thickness, width, direction, continuity) with interaction light & environment / material (brightness, colour, opacity and magnetism)',
...
def remove_node_descriptions(apps, schema_editor):
    NodeDescription = apps.get_model('stratigraphies', 'NodeDescriptions')
