...
urlpatterns = [
    ...
    url(r'^metal-autocomplete/(?P<model>[\w-]+)/$', artefacts_views.GenericAutoComplete.as_view(create_field='element'), name='metal-autocomplete'),
    url(r'^element-autocomplete/(?P<model>[\w-]+)/$', artefacts_views.ElementAutoCompleteFromList.as_view(), name='element-autocomplete'),
