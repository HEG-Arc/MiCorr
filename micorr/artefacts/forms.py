...
class ArtefactFilter(django_filters.FilterSet):
    ...
    corrosion_form = django_filters.ModelChoiceFilter(label='Corrosion Forms', queryset=CorrosionForm.objects.filter(form__contains=CorrosionForm.corrosion_category), empty_label='All Corrosion Forms')
